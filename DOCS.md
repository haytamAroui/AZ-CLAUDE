...
46 commands -- /fix, /add, /audit, /blueprint, /ship, /evolve, /sentinel, /copilot, /parallel, /mcp, /spec, /constitute, /driven, /inoculate, /ghost-test, /ingest, /knowledge...
...
- **First time** → full install (46 commands, 10 skills, 16 agents, 5 hooks, memory, reflexes, evolution)
...
Runs 32 checks: Node.js version, project hooks, settings integrity, project structure, all 46 commands present. Exits 0 if healthy. Exits 1 with a specific fix hint if anything is wrong.
...
| **3** | 46 commands + lazy-loaded capabilities | ~380 tokens per task |
...
- **Commands** -- all 46 commands present
