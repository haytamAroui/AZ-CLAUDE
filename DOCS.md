...
> Version 0.7.6 · 2113 tests passing · AI coding environment
...
44 commands -- /fix, /add, /audit, /blueprint, /ship, /evolve, /sentinel, /copilot, /parallel, /mcp, /spec, /constitute, /driven, /inoculate, /ghost-test, /ingest, /knowledge...
...
- **First time** → full install (44 commands, 10 skills, 16 agents, 5 hooks, memory, reflexes, evolution)
...
Runs 32 checks: Node.js version, project hooks, settings integrity, project structure, all 44 commands present. Exits 0 if healthy. Exits 1 with a specific fix hint if anything is wrong.
...
| **3** | 44 commands + lazy-loaded capabilities | ~380 tokens per task |
...
- **Commands** -- all 44 commands present
