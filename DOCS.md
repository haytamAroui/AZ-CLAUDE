...
> Version 0.7.6 · 1996 tests passing · AI coding environment
...
42 commands -- /fix, /add, /audit, /blueprint, /ship, /evolve, /sentinel, /copilot, /parallel, /mcp, /spec, /constitute, /driven, /inoculate, /ghost-test...
...
- **First time** → full install (42 commands, 10 skills, 15 agents, 5 hooks, memory, reflexes, evolution)
...
Runs 32 checks: Node.js version, project hooks, settings integrity, project structure, all 42 commands present. Exits 0 if healthy. Exits 1 with a specific fix hint if anything is wrong.
...
| **3** | 42 commands + lazy-loaded capabilities | ~380 tokens per task |
...
- **Commands** -- all 42 commands present
