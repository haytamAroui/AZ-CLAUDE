...
> Version 0.7.6 · 2124 tests passing · AI coding environment
...
45 commands -- /fix, /add, /audit, /blueprint, /ship, /evolve, /sentinel, /copilot, /parallel, /mcp, /spec, /constitute, /driven, /inoculate, /ghost-test, /ingest, /knowledge...
5 hooks -- block secrets before writes, track every edit, inject context on start, migrate on stop
16 agents -- orchestrator team + spec-reviewer + constitution-guard + knowledge-compiler + framework agents
...
- **First time** → full install (45 commands, 10 skills, 16 agents, 5 hooks, memory, reflexes, evolution)
...
Runs 32 checks: Node.js version, project hooks, settings integrity, project structure, all 45 commands present. Exits 0 if healthy. Exits 1 with a specific fix hint if anything is wrong.
...
| **3** | 45 commands + lazy-loaded capabilities | ~380 tokens per task |
...
- **Commands** -- all 45 commands present
