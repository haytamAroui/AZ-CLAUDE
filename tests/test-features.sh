...
check "review: runs tests to verify"                      "templates/commands/review.md" "npm test\|run.*test\|verification method"
check "review: shows verification method in output"       "templates/commands/review.md" "Verification method"
