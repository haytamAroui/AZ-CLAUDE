...
check "review: copilot mode detection"             "$CMD/review.md" "COPILOT_MODE"
check "review: reviews against copilot-intent"     "$CMD/review.md" "copilot-intent.md.*spec\|spec.*copilot-intent"
